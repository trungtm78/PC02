...
export function renderSubjectsRoutes(): ReactElement[] {
  return [
    <Route key="objects" path="/objects" element={wrapRoute(<ObjectListPageShell subjectType="SUSPECT" />)} />,
    <Route key="suspects" path="/people/suspects" element={wrapRoute(<ObjectListPageShell subjectType="SUSPECT" />)} />,
    <Route key="victims" path="/people/victims" element={wrapRoute(<ObjectListPageShell subjectType="VICTIM" />)} />,
    <Route key="witnesses" path="/people/witnesses" element={wrapRoute(<ObjectListPageShell subjectType="WITNESS" />)} />,
  ];
}
