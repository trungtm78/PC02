...
const REC: LegacyRecord = {
  ...
  ngay_tam_dinh_chi_nguon_tin: '09/01/2020',
  phuc_hoi_nguon_tin_toi_pham: 'QD_PHUC_HOI',
  ngay_phuc_hoi_nguon_tin: '10/01/2020',
...
describe('EXPERT golden-master — CaseStatistic builder (ánh xạ + kiểu Int/Float)', () => {
  const STAT_REC: LegacyRecord = {
    ...
    so_sung_thu_hoi: '6',
    so_thuoc_no_thu_hoi: '7',
    so_doi_tuong_da_bat: '8',
    so_doi_tuong_bi_bat_vu_an_khac: '9',
    dieu_tra_mo_rong: '10',
    so_bang_nhom_bat_duoc: '11',
    co_ghi_am_ghi_hinh: 'Có',
    la_vu_an_ghi_am_ghi_hinh: 'Không',
    co_vphc: 'Có',
    co_bang_nhom: 'Không',
    xac_nhan_vu_an_da_duoc_xet_xu: 'Đã',
    ghi_am_ghi_hinh_da_duoc_xet_xu: 'Có',
    vu_an_co_su_dung_kqghi_am_trong_xet_xu: 'Không',
    vu_an_khong_gagh_nhung_toa_yeu_cau: 'Có',
